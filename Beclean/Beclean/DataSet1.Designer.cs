...
namespace Beclean {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(byte[] Imagine, string Adresa, string Nume, string NrTelefon, string Site, string Facebook, string Program) {
            ...
            private void InitClass() {
                ...
                this.columnNrTelefon.MaxLength = 50;
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string NrTelefon {
                get {
                    return ((string)(this[this.tableTable.NrTelefonColumn]));
                }
                set {
                    this[this.tableTable.NrTelefonColumn] = value;
                }
            }
            ...
            public string Facebook {
                get {
                    return ((string)(this[this.tableTable.FacebookColumn]));
                }
                set {
                    this[this.tableTable.FacebookColumn] = value;
                }
            }
...
namespace Beclean.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Adresa] = @Original_Adresa) AND ([Nume] = @Original_Nume) AND ([NrTelefon] = @Original_NrTelefon) AND ([Site] = @Original_Site) AND ([Facebook] = @Original_Facebook) AND ([Program] = @Original_Program))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Table] ([Imagine], [Adresa], [Nume], [NrTelefon], [Site], [Facebook], [Program]) VALUES (@Imagine, @Adresa, @Nume, @NrTelefon, @Site, @Facebook, @Program);
SELECT Id, Imagine, Adresa, Nume, NrTelefon, Site, Facebook, Program FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Imagine] = @Imagine, [Adresa] = @Adresa, [Nume] = @Nume, [NrTelefon] = @NrTelefon, [Site] = @Site, [Facebook] = @Facebook, [Program] = @Program WHERE (([Id] = @Original_Id) AND ([Adresa] = @Original_Adresa) AND ([Nume] = @Original_Nume) AND ([NrTelefon] = @Original_NrTelefon) AND ([Site] = @Original_Site) AND ([Facebook] = @Original_Facebook) AND ([Program] = @Original_Program));
SELECT Id, Imagine, Adresa, Nume, NrTelefon, Site, Facebook, Program FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Beclean.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Imagine, Adresa, Nume, NrTelefon, Site, Facebook, Program FROM dbo.[Ta" +
                "ble]";
        ...
        public virtual int Delete(int Original_Id, string Original_Adresa, string Original_Nume, string Original_NrTelefon, string Original_Site, string Original_Facebook, string Original_Program) {
            ...
            if ((Original_NrTelefon == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_NrTelefon));
            }
            ...
            if ((Original_Facebook == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_Facebook));
            }
        ...
        public virtual int Insert(byte[] Imagine, string Adresa, string Nume, string NrTelefon, string Site, string Facebook, string Program) {
            if ((Imagine == null)) {
        ...
        public virtual int Update(byte[] Imagine, string Adresa, string Nume, string NrTelefon, string Site, string Facebook, string Program, int Original_Id, string Original_Adresa, string Original_Nume, string Original_NrTelefon, string Original_Site, string Original_Facebook, string Original_Program, int Id) {
            if ((Imagine == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(byte[] Imagine, string Adresa, string Nume, string NrTelefon, string Site, string Facebook, string Program, int Original_Id, string Original_Adresa, string Original_Nume, string Original_NrTelefon, string Original_Site, string Original_Facebook, string Original_Program) {
            return this.Update(Imagine, Adresa, Nume, NrTelefon, Site, Facebook, Program, Original_Id, Original_Adresa, Original_Nume, Original_NrTelefon, Original_Site, Original_Facebook, Original_Program, Original_Id);
        }
    }
